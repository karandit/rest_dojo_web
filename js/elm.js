...
var _user$project$RestDojo_API$dojosDecoder = _elm_lang$core$Json_Decode$list(
	A7(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'pointHistoryUrl', _elm_lang$core$Json_Decode$string)));
...
var _user$project$RestDojo_API$getPointHistory = function (url) {
	return A2(_evancz$elm_http$Http$get, _user$project$RestDojo_API$pointHistoryDecoder, url);
};
...
var _user$project$RestDojo_Cluedo_CluedoView$viewBot = function (bot) {
	...
	return A2(
		...
		A2(
			_elm_lang$core$List_ops['::'],
			_user$project$RestDojo_Cluedo_CluedoView$teamImgByName(bot.teamName),
			cardImgs));
};
	...
	function (dojo, game) {
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$RestDojo_Cluedo_CluedoView$viewBots(game.bots),
				A2(
	...
	return {
		...
		datasets: A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					['#7e5ae2', '#e25abc', '#e25a77', '#7e9ce2', '#f78764', '#1784c7']),
				pointHistory.teams))
	};
};
		...
		switch (_p3.ctor) {
			case 'BillboardLoadSucceed':
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$RestDojo_Main$initDojos(_p4.dojosUrl)
						]));
			...
			case 'SelectDojo':
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$RestDojo_Main$initTeams(_p5),
							_user$project$RestDojo_Main$loadPointHistory(_p5)
						]));
			case 'SelectGame':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_user$project$RestDojo_Main$initGame, _p3._0, _p3._1)
						]));
			case 'PointHistoryLoadSucceed':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$RestDojo_Main$chart(
							_user$project$RestDojo_Main$mapToChartInput(_p3._0))
						]));
			case 'GameLoadSucceed':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							route: A2(_user$project$RestDojo_Types$GameRoute, _p3._0.id, _p3._1)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['RestDojo']['Main'], 'RestDojo.Main', typeof _user$project$RestDojo_Main$main === 'undefined' ? null : _user$project$RestDojo_Main$main);
